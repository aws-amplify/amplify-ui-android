...
class SignInContinueWithTotpSetupRobot(composeTestRule: ComposeTestRule) : ScreenLevelRobot(composeTestRule) {
    ...
    fun clickCopyKeyButton() = clickOnTag(TestTags.CopyKeyButton)
}
